...
export default function App() {
  ...
  return (
    <SessionContext.Provider value={{ session, userSession, handleSignIn, handleSignOut }}>
...
function Avatar() {
  const { session, userSession, handleSignIn, handleSignOut } = useContext(SessionContext);
